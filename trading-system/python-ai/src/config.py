...
class AIConfig(BaseModel):
    ...
    use_legacy_features: bool = Field(default=False)
    inference_interval_seconds: int = Field(default=30)
    ...
    def from_env(cls) -> "AIConfig":
        return cls(
            ...
            use_legacy_features=os.getenv("USE_LEGACY_FEATURES", "false").lower() == "true",
            inference_interval_seconds=int(os.getenv("INFERENCE_INTERVAL_SECONDS", str(cls.model_fields["inference_interval_seconds"].default))),
        )
